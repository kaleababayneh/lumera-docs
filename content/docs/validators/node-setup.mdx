...
description: Install dependencies, build lumerad from source, and sync your node using a snapshot.
icon: Server
---
...
Replace `lumera_XXXXXXX.tar.lz4` with the current filename from the Polkachu page. This downloads and extracts in one step — takes 5–30 minutes depending on network speed.
