...
Cascade is a **permanent decentralized storage protocol** built into the [Lumera Protocol](https://lumera.io) — a Cosmos SDK Layer-1 blockchain. It enables developers to store files on a distributed network of Supernodes with a single on-chain transaction.
