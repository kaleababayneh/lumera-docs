...
The [Go SDK](https://github.com/LumeraProtocol/sdk-go) is the official SDK for building server-side applications, CLI tools, and backend services that interact with Lumera Protocol. It needs direct gRPC access to the chain and native Supernode communication.
