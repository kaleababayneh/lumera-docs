...
`@cosmjs/proto-signing` and `@cosmjs/stargate` are **peer dependencies** required for wallet and transaction handling. `@cosmjs/amino` is needed for ADR-036 `signArbitrary` support in Node.js environments (browser wallets like Keplr handle this natively).
...
|-----|---------|------------|
| **Go** | `go get github.com/LumeraProtocol/sdk-go` | [LumeraProtocol/sdk-go](https://github.com/LumeraProtocol/sdk-go) |
| **Rust** | `lumera-sdk-rs = "0.1"` | [LumeraProtocol/sdk-rs](https://github.com/LumeraProtocol/sdk-rs) |
| **TypeScript** | `npm install @lumera-protocol/sdk-js` | [LumeraProtocol/sdk-js](https://github.com/LumeraProtocol/sdk-js) |
