---
title: Lukso primer
description: A short tour of Universal Profiles, LSP standards, and the on-chain data shapes that make Cascade a drop-in storage layer.
icon: BookOpen
---
...
- [**LSP-1 Universal Receiver**](https://docs.lukso.tech/standards/accounts/lsp1-universal-receiver) a notification hook that fires when the account receives anything (assets, vaults, arbitrary data). Out of scope for storage.
...
You don't compute these keys by hand: [`@erc725/erc725.js`](https://www.npmjs.com/package/@erc725/erc725.js) ships a JSON schema for every standard key and handles the encoding for you.
...
The two `method-id`s you'll see in the wild:
