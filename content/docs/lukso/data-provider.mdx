---
title: Data-provider package & cascade-api
...
2. **Self-host a cascade-api.** Clone the [cascade-api](https://github.com/...) repo, point your dApp at your domain, control your own uptime. The HTTP surface is identical, so client code ports as-is.
...
First run derives your `lumera1...` address from the mnemonic, registers its pubkey on chain, opens a Cascade SDK client, and starts serving. Fund the address with at least 50000 ulume from the [faucet](/docs/faucet) before the first upload.
...
- Package: `@lumera-protocol/data-provider-cascade` on npm
- HTTP surface: cascade-api repo
- Reference dApp using both: [github.com/kaleababayneh/permanent-up](https://github.com/kaleababayneh/permanent-up)
