...
If you have not used Lukso before, start with the [primer](/docs/lukso/primer). If you already know Universal Profiles and just want the working code, jump to the [Universal Profile tutorial](/docs/lukso/universal-profile), which mirrors the bundled `permanent-up-app` reference implementation end-to-end. If you just want to see it work, [Try Cascade](/docs/lukso/try-cascade) walks through the live in-page UP editor.
