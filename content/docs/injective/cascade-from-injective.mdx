...
[Build your own integration](/docs/injective/build-your-own#contract-side-conventions) has the code for both, plus two production conventions: modelling the workflow as a state machine, and locking funds atomically with the CID write.
...
| Your service's Lumera key (Pattern B) | Each `MsgRequestAction` your service signs on behalf of users | [Faucet](/docs/faucet) |
