...
description: Use Lumera Cascade as the permanent storage layer for Injective dApps — claims, evidence, justifications, settlement records — over IBC + Interchain Accounts.
icon: Network
---

[Injective](https://injective.com) is a CosmWasm-2.0 Layer-1 with a native orderbook module, sub-second finality, and full IBC connectivity. Most Injective apps store state on-chain and pin large auxiliary data — trade receipts, NFT metadata, governance attachments, oracle evidence — to IPFS or a centralised bucket. That auxiliary data lives only as long as someone keeps paying to host it.
