...
Injective has a chain-level orderbook for spot and derivatives markets.
...
The Injective wallet model is essentially Ethereum's: the curve is **eth_secp256k1**, derivation is BIP-44 with `coinType: 60`, and addresses are bech32-encoded `keccak256`. 
